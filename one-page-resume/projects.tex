...
%---------------------------------------------------------
\cventry
{Autonomous Underwater Vehicle} % Organization/group
{Team AUV-IITK} % Location
{Faculty Advisor: Prof. Indranil Saha} % Affiliation/role
{April 2021 - Present} % Date(s)
{
  \begin{itemize} % Description(s) of experience/contributions/knowledge
    \item {Improved the \href{https://auv.sntiitk.in/}{team website}, which ranked \textbf{3rd} in \textbf{Robosub, 2021}} out of \textbf{52} participating teams, the largest competition for student built AUVs in the world
    ...
    % \item Researched for methods to \textbf{test} the FastSLAM algorithm in \textbf{underwater} conditions.
  \end{itemize}
}
  %---------------------------------------------------------
  \cventry
